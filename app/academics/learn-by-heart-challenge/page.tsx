      ...
      <div className="max-w-4xl mx-auto px-4 py-16">
        ...
        <div className="prose prose-slate max-w-none mb-16">
          <p className="text-slate-600 leading-relaxed mb-3">
            ...
            important piece in our goal to teach our students here what is true,
            what is good, and what is beautiful.
          </p>
          <p className="text-slate-600 leading-relaxed">
            As we joyfully take up the task our God has given us to do, to pass
            on this saving faith in Jesus, once delivered to the saint (Jude
            1:3) this framework is specifically designed to allow teachers to
            execute the plan in the best way according to age and abilities in
            the classroom. The ultimate goal is for our students to have tucked
            away in their hearts the very promises of Christ, so that, when the
            storms of life hit them, they will find that the Word of God dwells
            richly with them. (Philippians 4:7)
          </p>
        </div>
        ...
        <div className="bg-primary/5 rounded-lg p-8 mb-16">
          <p className="text-slate-600">
            To ensure continuity through all years of education, each classroom
            will use the 1986 version of Luther&apos;s Small Catechism, and the
            ESV translation of the Bible.
          </p>
        </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-white border border-slate-200 rounded-lg p-6">
                ...
                <ul className="space-y-3 text-slate-600">
                  ...
                  <li className="flex items-start">
                    <span className="text-primary mr-2">•</span>
                    All three articles of the Apostle&apos;s Creed (excluding
                    explanations)
                  </li>
                  <li className="flex items-start">
                    <span className="text-primary mr-2">•</span>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-white border border-slate-200 rounded-lg p-6">
                ...
                <ul className="space-y-3 text-slate-600">
                  ...
                  <li className="flex items-start">
                    <span className="text-primary mr-2">•</span>1 Corinthians
                    13:6
                  </li>
                  <li className="flex items-start">
                    <span className="text-primary mr-2">•</span>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-white border border-slate-200 rounded-lg p-6">
                ...
                <ul className="space-y-3 text-slate-600">
                  ...
                  <li className="flex items-start">
                    <span className="text-primary mr-2">•</span>2 Corinthians
                    5:21
                  </li>
                  <li className="flex items-start">
                    <span className="text-primary mr-2">•</span>
