          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-24">
            <div className="prose prose-slate max-w-none">
              ...
              <p className="text-slate-600 leading-relaxed mb-4">
                ...
                congregation of the Lutheran Church-Missouri Synod (LCMS), we
                are committed to faithful Lutheran worship and teaching.
              </p>
              <p className="text-slate-600 leading-relaxed">
                ...
                pastoral staff who are actively involved in both church and
                school life.
              </p>
            </div>
          ...
          <div className="bg-primary/5 rounded-lg p-12 mb-24">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="prose prose-slate max-w-none">
                ...
                <p className="text-slate-600 leading-relaxed">
                  Through hymns, Scripture readings, and age-appropriate
                  messages, our students learn to start each day by focusing on
                  God&apos;s Word and His promises. Parents and family members
                  are always welcome to join us for chapel services.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <AnimatedCard delay={0.3}>
                <div className="bg-white border border-slate-200 rounded-lg p-6">
                  ...
                  <p className="text-slate-600">
                    Older students serve as role models and mentors to their
                    younger chapel family members, developing leadership skills
                    and compassion.
                  </p>
                </div>
              </AnimatedCard>
              <AnimatedCard delay={0.4}>
                <div className="bg-white border border-slate-200 rounded-lg p-6">
                  ...
                  <p className="text-slate-600">
                    Chapel families sit together during services, helping
                    younger students learn worship practices and creating a
