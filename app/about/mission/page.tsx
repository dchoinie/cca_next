      ...
      <div className="max-w-6xl mx-auto px-4 py-16">
        <div className="text-center max-w-4xl mx-auto mb-16">
          <p className="text-xl md:text-2xl lg:text-3xl font-serif text-primary leading-relaxed">
            ...
            strive to help students grow in the grace and knowledge of our Lord
            Jesus Christ as they grow in body, mind and spirit with truth,
            goodness and beauty.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 mt-16">
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <p className="text-slate-600 leading-relaxed">
                ...
                every aspect of our education points to Christ. We believe that
                true wisdom begins with the fear of the Lord, and we integrate
                this truth into every subject and activity.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <p className="text-slate-600 leading-relaxed">
                Through the time-tested classical approach, we cultivate wisdom
                and virtue in our students. Our curriculum embraces truth,
                goodness, and beauty, helping students develop strong character
          ...
          <div className="flex flex-col md:flex-row gap-8 items-center">
            ...
            <div className="md:w-2/3">
              ...
              <p className="text-slate-600 leading-relaxed mb-4">
                ...
                children. Our role is to come alongside families, supporting and
                partnering with them in their God-given responsibility to raise
